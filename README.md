...
In this particular example, P1 is a patient and S1, S2 and S3 correspond to that patients’s samples at (e.g.) three time intervals. The naming of the sample class labels is arbitrary.
